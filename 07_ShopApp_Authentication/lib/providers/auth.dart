...
class Auth with ChangeNotifier {
  ...
  void _autoLogout() {
    ...
    final timerToExpire = _expiryDate!.difference(DateTime.now()).inSeconds;
    _authTimer = Timer(Duration(seconds: timerToExpire), logout);
  }
}
